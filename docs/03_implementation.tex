...
messages that might need to be re-sent. Requests are sent directly from this second queue when ending an election to try again after the
previous coordinator crashed. The coordinator enqueues incoming requests and broadcasts the \texttt{UPDATE} message for them, one by one.
