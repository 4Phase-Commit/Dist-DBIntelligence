...
\author{Soranzo Mendez Andrea Jesus, Caraffini Lorenzo}
\date{Distributed Systems 1 Project -- \today}

\begin{document}
    \maketitle
    \input{01_structure} % add classes and file system
    \input{02_design} % What, choices and protocol in words
    \input{03_implementation} % How
\end{document}
