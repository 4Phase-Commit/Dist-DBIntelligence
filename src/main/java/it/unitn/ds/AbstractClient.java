...
public abstract class AbstractClient extends AbstractActor {
    ...
    AbstractClient(long readTimeoutDelay, long writeTimeoutDelay, Optional<ActorRef> listener,
    ...
    private static class Result implements Serializable {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof Result) {
                return ((Result) obj).success == this.success && ((Result) obj).value == this.value
                        && ((Result) obj).index == this.index && ((Result) obj).fromReplica == this.fromReplica;
            }
    ...
    private static class Timeout implements Serializable {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof Timeout) {
                return ((Timeout) obj).client.equals(this.client) && ((Timeout) obj).replica.equals(this.replica)
                        && ((Timeout) obj).index == this.index;
            }
            return super.equals(obj);
        }
        ...
        @Override
        public int hashCode() {
            return Objects.hash(client, replica, index);
        }
    }
    ...
    /**
     * This function must be invoked whenever the client senses a timed-out read
     * request
     */
    ...
    /**
     * This function must be invoked whenever the client senses a timed-out write
     * request
     */
    ...
    private final void onReadRequest(AbstractClient.ReadRequest msg) throws Exception {
        if (msg.replica != null) {
            ...
            throw new Exception(
                    "Target replica not found: neither in AbstractClient.WriteRequest nor in AbstractClient.defaultTargetReplica.");
        }
    }
